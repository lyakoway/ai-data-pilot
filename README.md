...
- 🧪 **Тесты** — pytest (111 тестов) покрывают аналитический слой, SQL guard, self-correction, Agent Loop (ReAct), execution trace, мульти-источники (CSV + Excel), параметризованные сценарии, RAG Ксюши и app-БД
