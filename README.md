...
- 🧪 **Тесты** — pytest (102 теста) покрывают аналитический слой, SQL guard, self-correction, Agent Loop (ReAct), execution trace, мульти-источники (CSV + Excel), параметризованные сценарии и app-БД
